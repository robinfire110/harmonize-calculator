...
async function createFakerData(userNum, eventNum, financialNum) {
    ...
    for (let i = 0; i < userNum; i++) {
        //Create users
        let newUser = await db.User.create({ email: faker.internet.email(), password: faker.internet.password(), name: faker.person.firstName(), zip: ncZipCodes[getRandomInt(ncZipCodes.length)], bio: faker.person.bio() });
...
module.exports = { getRandomInt, getGasPrices, createFakerData, fixData, checkValidUserId, checkValidFinancialId }